...
| D8 | Menu tab: "View live menu" header link 36px tall | OPEN | Low | Text link, lower tap priority; revisit. |
| D9 | Orders, Appearance, QR, Settings tabs | _not yet measured_ | — | Pending — touch targets + token usage (measurable). |
